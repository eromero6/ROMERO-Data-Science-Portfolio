...
**How it complements this portfolio:** This project demonstrates foundational data wrangling skills —
the ability to take messy, real-world data and transform it into a structured format ready for analysis.
